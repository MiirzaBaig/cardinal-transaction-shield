...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Cardinal — Protection from every direction" },
      {
        name: "description",
        content:
          "Cardinal is a transaction firewall for Web3. We inspect every transaction before you sign — and tell you to allow, review, or block.",
      },
      { name: "author", content: "Cardinal" },
      { property: "og:title", content: "Cardinal — Protection from every direction" },
      {
